...
Summary(pl.UTF-8):	UNIVERSAL::exports - lekkie, uniwersalne eksportowanie zmiennych
...
Ten moduł jest alternatywą dla Exportera mającą udostępnić
uniwersalny, lekki podzbiór jego funkcjonalności. Używa modułu
Exporter::Lite, z którego można poznać więcej szczegółów.
